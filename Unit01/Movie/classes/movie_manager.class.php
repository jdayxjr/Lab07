 ...
 * Description: define the MovieManger class
 */
...
class MovieManager
{
    ...
    private $db;
    private $dbConnection; //Database object and database connection
    private static $_instance = NULL; //an instance of the current class
